...
$db[DB_NAME]['hostname'] = '127.0.0.1';
$db[DB_NAME]['username'] = 'ah_spider';//ah_spider
$db[DB_NAME]['password'] = 'spider23';//spider23
$db[DB_NAME]['database'] = 'distant_fun';//omega_test
$db[DB_NAME]['dbdriver'] = 'mysql';
$db[DB_NAME]['dbprefix'] = '';
$db[DB_NAME]['pconnect'] = TRUE;
