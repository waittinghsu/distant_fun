...
class Curl {
    ...
    public static function curl_func($url="",$post_data=array()){
    ...
    public static function curl_imgdownload($url="",$filepath=""){
            $cookiefile = tempnam('./temp', 'cookie');            
            $ch = curl_init();
            curl_setopt($ch, CURLOPT_URL, $url);
            curl_setopt($ch, CURLOPT_FOLLOWLOCATION, true);
            curl_exec($ch);
            $url = curl_getinfo($ch, CURLINFO_EFFECTIVE_URL);//轉為正確圖片url
