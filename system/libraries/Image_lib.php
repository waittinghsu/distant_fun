...
class CI_Image_lib {
	...
	var $wm_hor_alignment	= 'C';			// Horizontal alignment: L R C
        ...
        var $wm_hor_x_axis              = 0;            //set text distance by ?px
        var $wm_vrt_y_axis              = 0;            //set text distance by ?px
	...
	function overlay_watermark()
	{
		...
		$x_axis =$this->wm_hor_x_axis + $this->wm_hor_offset + $this->wm_padding;
		$y_axis =$this->wm_vrt_y_axis + $this->wm_vrt_offset + $this->wm_padding;
