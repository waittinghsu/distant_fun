...
if (isset($_SERVER['HTTP_HOST'])) {
    $http_ssl = isset($_SERVER['HTTPS']) && strtolower($_SERVER['HTTPS']) !== 'off' ? 'https://apps.ah-solution.com.tw/' : 'http://event.ah-solution.com.tw/';
}
...
define('WEB_IMG',WEBROOT_RESOURCE."/images");
define('WEB_C',WEBROOT_RESOURCE."/c");
define('WEB_J',WEBROOT_RESOURCE."/j");
define('IMG_DOC',DOCROOT."\\resource\images");
 ...
 *
 */
	$application_folder = 'ah_application';
